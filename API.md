...
<li><code>discord:&lt;id&gt;</code>      — bridged Discord guild thread (local bot; not Fabric mesh)</li>
<li><code>discord:dm:&lt;uid&gt;</code>  — Discord user DM (bot↔user; local bot loopback allowed)</li>
</ul>
...
<dt><a href="#isKnownAppRelayType">isKnownAppRelayType</a></dt>
<dd><p>True when <code>appType</code> is a known GoonCitizen / Group contract body type.</p>
</dd>
<dt><a href="#crypto">crypto</a></dt>
...
<p>Officer model: settings.officers is an allowlist of actor ids. If EMPTY and
<code>requireOfficers</code> is false, the register runs in permissive &quot;bootstrap&quot; mode
(everyone is an officer) for local desktop before roles are set. Hosted
<code>SC_MODE=server</code> sets <code>requireOfficers: true</code> so an empty allowlist denies
all officer mutations (set <code>SC_OFFICERS</code>).</p>
...
| [opts.json] | <code>boolean</code> | Persist collections as JSON files (Android /   Node-mobile — skip native Level). |
...
* [ChatManager](#ChatManager)
    ...
    * _instance_
        ...
        * [.get(id)](#ChatManager+get) ⇒ <code>object</code> \| <code>null</code>
        * [.setPinned(id, [opts])](#ChatManager+setPinned) ⇒ <code>object</code>
...
| Param | Type | Description |
| --- | --- | --- |
| data | <code>Object</code> | Message fields (`channel`, `body`, `author`, optional `handle` / `ts` / `attachment`). |
...
**Kind**: instance method of [<code>ChatManager</code>](#ChatManager)  
<a name="ChatManager+get"></a>

### chatManager.get(id) ⇒ <code>object</code> \| <code>null</code>
...
<a name="ChatManager+setPinned"></a>

### chatManager.setPinned(id, [opts]) ⇒ <code>object</code>
...
| id | <code>string</code> | 
| [opts] | <code>Object</code> | 
| [opts.pinned] | <code>boolean</code> | 
| [opts.actor] | <code>string</code> | 
...
* [FabricNetwork](#FabricNetwork)
    ...
    * _instance_
        ...
        * [.publishDiscordRequest(payload)](#FabricNetwork+publishDiscordRequest)
        * [.publishDiscordClaim(payload)](#FabricNetwork+publishDiscordClaim)
        * [.publishDiscordResponse(payload)](#FabricNetwork+publishDiscordResponse)
        * [.publishLookupRequest(payload)](#FabricNetwork+publishLookupRequest)
        * [.publishLookupClaim(payload)](#FabricNetwork+publishLookupClaim)
        ...
        * [.publishGroupChangeProposal(contractId, payload)](#FabricNetwork+publishGroupChangeProposal)
        * [.publishGroupChangeVote(contractId, payload)](#FabricNetwork+publishGroupChangeVote)
...
### fabricNetwork.encodeOpaqueMessage(message, [opts]) ⇒ <code>Object</code>
...
### fabricNetwork.\_wrapPeeringCandidateEnqueue(peer) ⇒ <code>void</code>
...
<a name="FabricNetwork+_sanitizePeerCandidates"></a>

### fabricNetwork.\_sanitizePeerCandidates(peer) ⇒ <code>void</code>
...
<a name="FabricNetwork+publishNoteShare"></a>

### fabricNetwork.publishNoteShare(payload)
...
| Param | Type | Description |
| --- | --- | --- |
| payload | <code>Object</code> | NoteShare / NoteUpdate fields |

<a name="FabricNetwork+publishIdentityCrossSign"></a>

### fabricNetwork.publishIdentityCrossSign(payload)
...
### fabricNetwork.publishGroupDataShare(contractId, payload)
...
| --- | --- | --- |
| contractId | <code>string</code> |  |
| payload | <code>Object</code> | GroupDataShare fields |

<a name="FabricNetwork+publishDiscordCatalogShare"></a>

### fabricNetwork.publishDiscordCatalogShare(contractId, payload)
...
| --- | --- | --- |
| contractId | <code>string</code> |  |
| payload | <code>Object</code> | DiscordCatalogShare or GroupDataShare fields |
...
<a name="FabricNetwork+publishDiscordRequest"></a>

### fabricNetwork.publishDiscordRequest(payload)
...
| Param | Type | Description |
| --- | --- | --- |
| payload | <code>Object</code> | DiscordRequest object |

<a name="FabricNetwork+publishDiscordClaim"></a>

### fabricNetwork.publishDiscordClaim(payload)
...
| Param | Type | Description |
| --- | --- | --- |
| payload | <code>Object</code> | DiscordClaim object |

<a name="FabricNetwork+publishDiscordResponse"></a>

### fabricNetwork.publishDiscordResponse(payload)
...
| Param | Type | Description |
| --- | --- | --- |
| payload | <code>Object</code> | DiscordResponse object |

<a name="FabricNetwork+publishLookupRequest"></a>

### fabricNetwork.publishLookupRequest(payload)
...
| Param | Type | Description |
| --- | --- | --- |
| payload | <code>Object</code> | LookupRequest object |

<a name="FabricNetwork+publishLookupClaim"></a>

### fabricNetwork.publishLookupClaim(payload)
...
| Param | Type | Description |
| --- | --- | --- |
| payload | <code>Object</code> | LookupClaim object |

<a name="FabricNetwork+publishLookupResponse"></a>

### fabricNetwork.publishLookupResponse(payload)
...
| Param | Type | Description |
| --- | --- | --- |
| payload | <code>Object</code> | LookupResponse object |
...
### fabricNetwork.publishMessageReceived(contractId, payload)
...
| --- | --- | --- |
| contractId | <code>string</code> |  |
| payload | <code>Object</code> | { messageId, receivedAt?, chatMessageId? } |

<a name="FabricNetwork+publishMessageReceipt"></a>

### fabricNetwork.publishMessageReceipt(contractId, payload, [opts])
...
| --- | --- | --- |
| contractId | <code>string</code> |  |
| payload | <code>Object</code> | { messageId, receiptAt?, receiptSig?, chatMessageId? } |
| [opts] | <code>Object</code> | forwarded to `_publishContractMessage` / `_signAndRelay` |
| [opts.relay] | <code>boolean</code> |  |
...
<a name="FabricNetwork+publishGroupChangeProposal"></a>

### fabricNetwork.publishGroupChangeProposal(contractId, payload)
**Kind**: instance method of [<code>FabricNetwork</code>](#FabricNetwork)  

| Param | Type | Description |
| --- | --- | --- |
| contractId | <code>string</code> |  |
| payload | <code>Object</code> | GroupChangeProposal object |

<a name="FabricNetwork+publishGroupChangeVote"></a>

### fabricNetwork.publishGroupChangeVote(contractId, payload)
**Kind**: instance method of [<code>FabricNetwork</code>](#FabricNetwork)  

| Param | Type | Description |
| --- | --- | --- |
| contractId | <code>string</code> |  |
| payload | <code>Object</code> | GroupChangeVote object |
...
<a name="FabricNetwork+requestPeerInventories"></a>

### fabricNetwork.requestPeerInventories() ⇒ <code>Object</code>
...
**Kind**: instance method of [<code>FabricNetwork</code>](#FabricNetwork)  
<a name="FabricNetwork+replyDocumentInventory"></a>

### fabricNetwork.replyDocumentInventory(originName, items) ⇒ <code>boolean</code>
...
* [MissionManager](#MissionManager)
    ...
    * [.upsertFromGameLog(data)](#MissionManager+upsertFromGameLog) ⇒ <code>Object</code>
...
<a name="MissionManager+upsertFromGameLog"></a>

### missionManager.upsertFromGameLog(data) ⇒ <code>Object</code>
...
| Param | Type | Description |
| --- | --- | --- |
| data | <code>Object</code> | Snapshot from functions/gameLogMissionRegister |
